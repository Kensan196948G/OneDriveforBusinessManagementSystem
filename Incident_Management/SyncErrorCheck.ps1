    ...
    if ($isAdmin) {
        ...
        foreach ($user in $allUsers) {
            ...
            try {
                ...
                # OneDriveのルートアイテムを取得
                $rootItems = Get-MgUserDriveRoot -UserId $user.UserPrincipalName -Expand Children -ErrorAction Stop
        ...
        try {
            ...
            # OneDriveのルートアイテムを取得
            $rootItems = Get-MgUserDriveRoot -UserId $UserUPN -Expand Children -ErrorAction Stop
